...
class PhysicalGroupAggrerationNode : public PhysicalProjectNode {
 public:
    PhysicalGroupAggrerationNode(PhysicalOpNode *node, const ColumnProjects &project, const node::ExprListNode *groups)
        : PhysicalProjectNode(node, kGroupAggregation, project, true), group_(groups) {
        output_type_ = kSchemaTypeTable;
        fn_infos_.push_back(&group_.fn_info());
    }
