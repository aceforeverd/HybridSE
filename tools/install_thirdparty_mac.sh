...
wget -nv --show-progress -O libzetasql.tar.gz https://github.com/aceforeverd/zetasql/releases/download/v0.2.0-beta17/libzetasql-0.2.0-beta17-darwin-x86_64.tar.gz
